 ...
 * 	    stripeClass: "offColor",  // the css class used to stripe table rows
        pageLength: "15",  // default number of rows to show
        ...
        imagePath: "/resources/images/icons"  //path to the icon files used for the paging buttons.
        enableRowSelector: false  //to enable row selector option.
        selectEvent: 'mouseover',
        activateEvent: 'click',
        selectedClass: 'selected'
        focusLinksOnSelect:false
 *
...
jQuery.extend(jQuery.tblFilter, {
    defaults: {
        ...
        decimalPlaces: 2,
        showDebug: false,
        imagePath: "/resources/images/icons",
    ...
    prototype: {
        ...
        filterTable: function(op) {
            ...
            if (this.settings.enableRowSelector) {
                jQuery.tableNavigation({
                    row_selector: "#listTable tbody tr",
                    select_event: this.settings.selectEvent,
                    activate_event: this.settings.activateEvent,
                    selected_class: this.settings.selectedClass,
                    focus_links_on_select: this.settings.focusLinksOnSelect
                });
            }
        },
        sortTable: function(){
        ...
        pageNav: function(e){
            ...
            switch (action) {
                ...
                case "Prev":
                    ...
                    break;
                case "Current":
                    val = parseInt($('#' + this.table.id + '_pageCurrent').text());
        ...
        updatePageNav: function(v, t, l){
            ...
            $('#' + this.table.id + '_pageCurrent').text(this.currentPage.toString());
            ...
            if (v <= this.settings.pageLength) {
                $('#' + this.table.id + '_itemRange').hide();
            } else {
                $('#' + this.table.id + '_itemRange').show();
                var itemFrom = (this.currentPage - 1) * this.settings.pageLength + 1;
                $('#' + this.table.id + '_itemFrom').text(itemFrom.toString());
                var itemTo = this.currentPage * this.settings.pageLength;
                $('#' + this.table.id + '_itemTo').text((itemTo > v ? v : itemTo).toString());
            }
        },
        parseTable: function(){
            ...
            if (this.settings.paging && this.tbody.rows.length) {
                ...
                this.pagingRow.append('<td colspan="' + this.cellCount + '" align="left" nowrap="nowrap" valign="middle"><div id="' + this.table.id + '_p_base"><table cellspacing="0" cellspadding="0" border="0" style="width:100%;background:inherit;color:inherit;font:inherit;"><tr style="background:inherit;color:inherit;font:inherit;"><td style="text-align:left;background:inherit;color:inherit;font:inherit;"><span id="' + this.table.id + '_pageVisible"></span>&nbsp;item(s) found<span id="' + this.table.id + '_itemRange">, displaying <span id="' + this.table.id + '_itemFrom"></span>&nbsp;to&nbsp;<span id="' + this.table.id + '_itemTo"></span></span></td><td style="text-align:right;background:inherit;color:inherit;font:inherit;"><img id="' + this.table.id + '_pageFirst" src="' + ip + '/page-first-disabled.gif" align="absmiddle" alt=""> <img id="' + this.table.id + '_pagePrev" src="' + ip + '/page-prev-disabled.gif" align="absmiddle" alt="">  Page <span id="' + this.table.id + '_pageCurrent">1</span> of <span id="' + this.table.id + '_pageCount">' + this.maxPage + '</span> <img id="' + this.table.id + '_pageNext" src="' + ip + '/page-next.gif" align="absmiddle" alt=""> <img id="' + this.table.id + '_pageLast" src="' + ip + '/page-last.gif" align="absmiddle" alt=""></td></tr></table></div></td>').find("img").css("cursor", "pointer").bind("click", this, function(e){
                    e.data.pageNav(e)
            ...
            if (!this.colgroup.size()) {
                this.colgroup = jQuery('<colgroup>' + '</colgroup>').prependTo(this.table);
            }
            else {
        ...
        parseColumns: function(){
            ...
            var row, cell, text, textLength, dataType;
...
/*
*
*jquery.tableFilter-packed.js ends
*
*/
